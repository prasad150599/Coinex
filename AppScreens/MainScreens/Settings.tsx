...
const SettingsScreen = () => {
    ...
    const UserLogout =()=>{
            hideDialog();
            navigation.navigate('AuthStack', { screen: 'WelcomeLogin' })
    }
                ...
                <View style={{ flex: 6, backgroundColor: '#191C26' }}>
                    ...
                    <Portal>
                        <Dialog visible={visible} onDismiss={hideDialog}>
                            ...
                            <Dialog.Content>
                                <Text style={styles.bodyMedium}>Are you sure, you want to logout ?</Text>
                            </Dialog.Content>
                            <Dialog.Actions>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} style={{ width: '90%', height: 610, backgroundColor: '#1E2230', alignSelf: 'center', margin: 20, borderRadius: 10 }}>
                        ...
                        <View style={{ flex: 5, marginTop: 10 }}>
                            ...
                            <CustomeNavigationComp LeftIcon={'sign-out'} LeftIconColor={'#ffffff'} LeftIconSize={30} RightIcon={"chevron-right"} RightIconColor={"#ffffff"} RightIconSize={30} title={'Sign Out'} onp={() => {showDialog()}} changeItem={false} />
                        </View>
