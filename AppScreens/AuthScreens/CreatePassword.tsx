...
const CreatePassword = (prop:any) => {
    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: '#191C26' }}>
            <View style={{ flex: 1 }}>
                <CustomeScreen ScreenName={'Create Password'} style={{ margin: 10 }} imagePath={require('../../Resources/Images/PasswScreenLogo.png')} SecondIcon={false} ScreenLogo={true} IconName={undefined} />
            </View>
            ...
            <View style={{ flex: 2, marginTop: '10%' }}>
               ...
               <CustomInput iconName={'eye'} placeholderText={'Password'} secureText={true} typing={(text:any)=>{setPassword(text);}} keyboardType={"default"} />
               ...
               <Text style={{ fontSize:18, color: hasnumber(password) ? '#4DE0D9' : '#ffffff'}}>
                ...
                <CustomButton title={'Continue'} style={{ height: 60, width: '86%' }}
                  onp={SetPassword}/>                                   
